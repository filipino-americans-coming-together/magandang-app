...
export const WORKSHOPS = {
  allIds: [
    ...
    "Freshman-Workshop",
    "Walang-Makakatigil",
    "The-FilAm-Millionaire-Next-Door",
    "Fearing-the-Tsinela",
    "The-Fight-Against-Violence-Against-Women",
    "Itukoy-Ang-Kapalaran-Ng-Mandirigma",
    "Tsismis",
    "Are-you-_____-enough",
    "Creating-Value-and-Leadership",
    "The-Fit-Bit",
    "Define-Your-Destiny-STEM",
    "Define-Your-Destiny-Healthcare",
    "Define-Your-Destiny-Education-and-Politics",
    "Define-Your-Destiny-Media-&-The-Arts",
    "Define-Your-Destiny-Business-and-Finance",
    "Inspiration-Growth-and-Prosperity"
  ],
  byId: {
    "Mental-Health-And-Self-Empowerment": {
...
export const FACILITATORS = {
  allIds: [
    ...
    "Louie-Tan-Vital",
    "ANAKBAYAN-Detroit",
    "Sergio-Cadiena-Cat-Taylo",
    "Michelle-Macrohon",
    "Prism-Kru",
    "Migrante-Chicago",
    "MAFA",
    "Jess-Bautista-And-Tia-Mangahas",
    "Jennifer-Mendez",
    "Dance2XS-UIUC",
    "Christina-Carpio",
    "Gericault-De-La-Rose",
    "Cathlyn-Ferolin-and-Jayana-Tabbilos",
    "Gilary-Valenzuela",
    "Robert-Daradar",
    "Daniel-Jefferson",
    "Alpha-Phi-Gamma",
    "Jose-Concepcion",
    "Marianne-Reyes-and-Marielle-Gamo",
    "Lily-Hurt",
    "Jared-Peter-Lavengco",
    "Nathan-Almaria-Mark-Gomez-Chris-San-Juan-Patrick-Cayanan",
    "Panel-STEM",
    "Panel-Health",
    "Panel-Ed-Pol",
    "Panel-Med-Art",
